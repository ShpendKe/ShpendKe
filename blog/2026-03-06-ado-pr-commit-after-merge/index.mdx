---
title: "Merged PR: Azure DevOps commit message is now finally without the PR ID possible"
...
<CenteredImage 
  src={require("./images/conventionalcommits.png").default}
  width={500}
  caption="Manually overriding commit message while completing a PR in Azure DevOps"
/>
...
<CenteredImage 
  ...
  width={500}
  caption="Disable the PR ID prefix in Azure DevOps settings"
/>
...
The feature is limited by disabling it per repository. You can not set this globally for all repositories.
