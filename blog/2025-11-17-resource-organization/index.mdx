---
title: Practical guide to organizing Azure resources
...
Maybe you are in a small organization where one team wears multiple hats.
That's fine. You should think about how your solution will scale as the organization grows.
...
<img src={require("./images/grouping.png").default} alt="Azure grouping mechanism overview"/>
